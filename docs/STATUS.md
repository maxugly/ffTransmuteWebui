...
| **Pool thumb continuity** | Atomic recycle + 128 MiB browser decode LRU. Known thumbs stay painted while scrolling; pending is a labeled placeholder, never a hole or previous face. Sequence chips untouched | `thumb-decode-cache.js` · **`6.1`** |
...
- **Current:** `000.000.6.1` (Pool thumbnail continuity: atomic recycle + 128 MiB decode cache. Catalog virtualization still Partial at `5.37`.)
