...
/* ═══════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════ */
const MODELS_ROWS = [
  { model: 'LTX Video 2.5 (Upsampler) (⚡ Latest · T2V+I2V)', native: '768x512 class, Divisible by 32, default 1216x704 @30fps', sweet: '768x512 single-stage or 960x544 / 1280x720 final via 2x latent upsampler', max: 'Native 4K @ up to 50 fps (3840x2176 tiled)', dur: '5s (121f @24fps) default, API 6-20s (720p/1080p) 6-10s (4K)', fl2v: 'yes', audio: 'yes', notes: 'LTX2TwoStagePipeline / LTX2LatentUpsamplePipeline', strengths: 'Native 4K AV, 2-stage latent upscaler, 50fps', weaknesses: 'Needs 2 stages for best quality, high VRAM for 4K' },
  { model: 'LTX Video 2.5 Distilled (⚡ Latest · T2V+I2V)', native: 'Training buckets 960x544x49, Stage1 960x544 -> Stage2 1920x1088', sweet: 'Single-stage 768x512 or 960x544 @24fps 97-121f, 8 steps stage1 + 4 steps stage2', max: 'Native 4K @ up to 50 fps', dur: '5s (121f) sweet, practical 97-161f (4-6.7s), up to 20s API', fl2v: 'yes', audio: 'yes', notes: 'Fastest inference', strengths: '8-step distilled, guidance_scale=1.0, fastest LTX 2.5', weaknesses: 'Duplicates/disintegrates above 1280x704 in I2V' },
  { model: 'LTX Video 2.3 Distilled (High Quality · T2V+I2V)', native: '1216x704 native -> 1920x1088 upscale, example 480x832, 720p class', sweet: '768x512 @97f (~4s) - 40s @768x512 and 50s @1280x704 on RTX 5090', max: '4K via latent upscaler, up to 20s', dur: '4-6s sweet, max 20s single generation', fl2v: 'yes', audio: 'yes', notes: 'Distilled default', strengths: '50% lower compute, consumer GPU, synced stereo audio', weaknesses: 'LTX-2.0 LoRAs incompatible, 1920x1080 untested on 32GB' },
  { model: 'LTX-2.3 F2LF (First-Last Frame · T2V+I2V)', native: '720p native (range 480p-1440p native, 4K via upscaler), divisible by 32, 8n+1 frames', sweet: '768x512 to 1280x720 (720p) @121f (~5s @24fps), 704x416x97f on 8GB', max: '4K (2160p) via 2-stage latent upscale, Fast reaches 20s', dur: '5-6s coherence, up to 10s, max 20s, API 6/8/10/12/14/16/18/20s', fl2v: 'yes', audio: 'yes', notes: 'Video_ltx2_3_flf2v workflow', strengths: 'Native first+last frame interpolation, 20s max one pass', weaknesses: 'Needs start+end image for best use' },
  { model: 'LTX Video 2 TURBO (High Quality · T2V+I2V)', native: '720p-1080p native, Native 4K Fidelity', sweet: '720p Standard @6s - 6s Full HD in 5s', max: 'Native 4K @ up to 48-50 fps, clips up to 10s, up to 20s audio', dur: '6-10s sweet, I2V 6-20s up to 4K', fl2v: 'yes', audio: 'yes', notes: 'TURBO = Fast variant', strengths: 'Fast prototyping, 5s for 6s 1080p, open-source 19B', weaknesses: 'Still heavy 19B, 4K needs 2-stage' },
  { model: 'LTX Video 0.9.8 13B Distilled (High Quality · T2V+I2V)', native: '768x512 @24fps, new default 1216x704 @30fps', sweet: '768x512 / 512x768 base, cheap HD 704x1216 / 1216x704, 7 steps guidance 1', max: 'Up to 1280px natively, 1920x1080 via ltxv-spatial-upscaler-0.9.8', dur: '5s @24-30fps ideal, 15-30s reliable, up to 60s via chunking, max 1441f', fl2v: 'no', audio: 'no', notes: 'Old arch, 13B', strengths: 'Fits 12-16GB VRAM, 8 steps, long-form 60s', weaknesses: 'No native audio, needs upscaler for 1080p+' },
  { model: 'Omni Video Custom (⚡ Fast Motion · T2V+I2V)', native: 'Unknown - custom factory model, inferred 720p-class', sweet: 'Unknown - inferred 720p / 1216x704', max: 'Unknown - inferred 720p-1080p', dur: 'Unknown - inferred 5s', fl2v: 'no', audio: '?', notes: 'Custom - HF Space Omni Video Custom-fast-motion', strengths: 'Fast motion focused, video extend, listed with LTX/Wan', weaknesses: 'Zero docs, custom no public card' },
  { model: 'Wan 2.2 Fast (⚡ Fast · T2V+I2V)', native: '480P & 720P MoE, high-quality 720p dataset', sweet: '480p (832x480 @16fps, 53f) cheap, RIFE interpolation', max: '1280x720 (720P) natively, 1080p via external upscaler', dur: '5s (81f @16fps)', fl2v: 'no', audio: 'no', notes: 'A14B-NFE4 distilled', strengths: '4-step LightX2V Lightning LoRA, 20s vs 147s base @720p, complex motion retained', weaknesses: '720p max native, no audio' },
  { model: 'Wan 2.2 I2V rCM (I2V Only · T2V+I2V)', native: '480P & 720P, 5s @720P 16fps target, Best 720p', sweet: '480p (832x480) 8.0s distill vs 720p (1280x720) 20.0s distill', max: '720P native, 1080x1920 works via scale', dur: '5s (81f @16fps), extendable 81-109f (6.8s)', fl2v: 'yes', audio: 'no', notes: 'TurboWan2.2-I2V-A14B-720P', strengths: 'rCM 4-step turbo, I2V optimized, complex motion', weaknesses: 'No audio, I2V only' },
  { model: 'Wan 2.2 I2V (LoRA) (I2V Only · T2V+I2V)', native: '480P & 720P MoE, 5s @ up to 720p/24fps', sweet: '480p class 832x480 @16fps, 832x480 @16fps (53f) + RIFE', max: '1280*720 (720p)', dur: '5s (supports 5, 8s), 81f @16fps', fl2v: 'yes', audio: 'no', notes: 'I2V High/Low Noise rank64 lightx2v 4step', strengths: 'LoRA camera controls, must use with Wan2.2-I2V-A14B base, fast', weaknesses: 'Cannot standalone, LoRA only, no audio' },
  ...
  { model: 'MiniMax H3 (High Quality · T2V+I2V) / Hailuo 03', native: '768p - short edge 768px, area cap 768x1344, H3-Base at 768p', sweet: '768P @ 5-15s, $0.09/s vs 2K @ $0.13/s, 768p while iterating', max: '2K (2560x1440, 1440p short edge) @ up to 15s, 24 FPS', dur: '4-15s allowed, sweet 5-10s, default 124f ~5s', fl2v: 'yes', audio: 'yes', notes: 'Alias Hailuo 3.0', strengths: 'Native stereo audio up to 2K 15s, good character consistency', weaknesses: 'Physics best at 768p not 2K, expensive at 2K' },
  { model: 'Vidu 1.0 / 1.5 / 2.0', category: 'Precision / Control', released: '2025-01', native: '1080p', sweet: '540p drafts, 720p default, 1080p final', max: '1080p', dur: '4s or 8s', fl2v: 'yes', audio: '?', notes: 'Legacy line — Q-series supersedes it', strengths: 'Early reference-to-video + one-click prompt templates; cheap drafts on old tiers', weaknesses: 'Superseded by Q3 in everything that matters; legacy docs are thin', tips: 'Only reach for these when Q3 credits sting — same anchor discipline applies' },
  { model: 'Vidu Q1 / Q3-Pro / S1', category: 'Precision / Control', released: '2026-01', native: '540p/720p/1080p tiers (Q3 Pro)', sweet: '720p drafts, 1080p Pro finals', max: '1080p up to 16s', dur: 'Flexible 1-16s (Q1 start-end fixed 5s)', fl2v: 'yes', audio: 'yes', notes: 'Start-end magic is the flagship; S1 is a separate real-time line', strengths: 'Start-end interpolation is the reason to come — dedicated viduq1-start-end endpoint, Q3 does 1-16s; reference-to-video with 1-7 images; arena-ranked on image-conditioned generation', weaknesses: 'T2V arena presence is nil — references-first model, pure prompting is not its game; API docs disagree across tiers; closed weights, no model card', tips: 'Lead with two anchors, not a prompt — same subject/setting, aspect ratios within 0.8-1.25 or it cuts instead of interpolating; describe the motion between frames; reuse seed for revisions; Turbo to iterate, Pro to finish' },
  ...
  { model: 'Pixverse 6.0 / Motion 2.0', native: '720p', sweet: '640x640 / 720p', max: '1080p', dur: '—', fl2v: '?', audio: '?', notes: '', strengths: 'Fast, stylized, good for social-cut content', weaknesses: 'Realism takes a back seat to style, resolution modest' },
  { model: 'Van Gogh Relax Fast', native: '720p', sweet: '540p draft, 720p default', max: '720p', dur: '5s', fl2v: '?', audio: 'no', notes: 'Use for drafts, then upscale to Standard/HQ', strengths: 'Fastest painterly pass, heavy impasto / swirl, good for style tests', weaknesses: 'Low detail, temporal flicker, no audio, soft edges' },
  { model: 'Van Gogh Relax Standard', native: '1080p', sweet: '720p default', max: '1080p', dur: '5s', fl2v: '?', audio: 'no', notes: 'Best daily driver for Van Gogh', strengths: 'Balanced Van Gogh look, retains detail better than Fast, still quick', weaknesses: 'No audio, can warp small objects like dice / rigging' },
  { model: 'Van Gogh Relax HQ', native: '1080p', sweet: '1080p default', max: '1080p', dur: '5-8s', fl2v: '?', audio: 'no', notes: 'Use for final art pass after Real Motion', strengths: 'Highest brush detail, thick oil texture, most stable style of the 3', weaknesses: 'Slowest, most expensive, no audio' },
  { model: 'Real Motion 3.5 Turbo', native: '1080p', sweet: '720p draft, 1080p final', max: '1080p', dur: '5s or 8s', fl2v: '?', audio: 'yes', notes: 'Top pick - your overhead battle model. Free tier available.', highlight: true, strengths: 'Current flagship - best physics + audio sync, turbo fast, Free tier available', weaknesses: 'Can still eat small props like dice - same issue you saw with Veo' },
  { model: 'Real Motion 3.5', native: '1080p', sweet: '720p draft, 1080p final', max: '1080p', dur: '5s or 8s', fl2v: '?', audio: 'yes', notes: 'Use when you need max quality over speed', strengths: 'Full quality 3.5, slightly cleaner than Turbo, audio sync', weaknesses: 'Slower than Turbo, no Free tier' },
  { model: 'Real Motion 3.1 Turbo', native: '1080p', sweet: '540p drafts, 720p default, 1080p final', max: '1080p', dur: '5s', fl2v: '?', audio: 'yes', notes: 'Good cheap draft for your sinking-dice gag. Free tier available.', strengths: 'Fast iteration, good subject consistency, Free tier, audio', weaknesses: 'Older physics than 3.2/3.5, can drift on long shots' },
  { model: 'Real Motion 3.1', native: '1080p', sweet: '720p default', max: '1080p', dur: '5s or 8s', fl2v: '?', audio: 'yes', notes: '', strengths: 'Stable 3.1 base, better motion than 2.6/Turbo, audio', weaknesses: 'No turbo speed, mid-pack vs 3.5' },
  { model: 'Real Motion 3.2', native: '1080p', sweet: '720p default', max: '1080p', dur: '5s or 8s', fl2v: '?', audio: 'yes', notes: 'Best for scenes with climbers + ships + planes together', strengths: 'More stable than 3.1 on multi-object scenes like your board', weaknesses: 'No turbo, slightly softer than 3.5' },
  { model: 'Real Motion Turbo', native: '720p', sweet: '540p drafts, 720p default', max: '720p', dur: '5s', fl2v: '?', audio: 'no', notes: 'Use for quick camera tests only. Free tier available.', strengths: 'Free, super fast, lightweight', weaknesses: '720p ceiling, no audio, weak physics' },
  { model: 'Real Motion 2.6', native: '720p', sweet: '540p default', max: '720p', dur: '5s', fl2v: '?', audio: 'no', notes: 'Legacy - only if you need Free', strengths: 'Free, oldest stable base, runs on low credits', weaknesses: 'No audio, dated motion, soft' },
  ...
  { model: 'Happy Horse 1.0', native: '-', sweet: '-', max: '-', dur: '-', fl2v: '-', audio: '-', notes: 'Base model, predecessor to 1.1', strengths: '-', weaknesses: '-' },
  { model: 'Happy Horse Edit', native: '-', sweet: '-', max: '-', dur: '-', fl2v: '-', audio: '-', notes: '-', strengths: '-', weaknesses: '-' },
  { model: 'Minimax H3 Max', native: '2K', sweet: '-', max: '2K', dur: '15s', fl2v: 'yes', audio: 'yes', notes: 'Fast inference, optimized with fal.ai', strengths: '-', weaknesses: '-' },
  ...
  { model: 'Grok Imagine Video', native: '-', sweet: '-', max: '-', dur: '-', fl2v: '-', audio: 'yes', notes: 'Integrated into X/Grok', strengths: '-', weaknesses: '-' },
  { model: 'Gemini Omni 1.1 Flash', native: '-', sweet: '-', max: '4K', dur: '40s', fl2v: 'yes', audio: 'yes', notes: 'Conversational editing, scene extension', strengths: '-', weaknesses: '-' },
  { model: 'Gemini Omni Flash', native: '-', sweet: '-', max: '-', dur: '-', fl2v: '-', audio: '-', notes: '-', strengths: '-', weaknesses: '-' },
  { model: 'Runway Gen-4S', native: '720p', sweet: '-', max: '-', dur: '5s', fl2v: 'yes', audio: '-', notes: 'Presumed fast/short variant', strengths: '-', weaknesses: '-' },
  { model: 'Runway Gen 4', native: '720p', sweet: '1080p', max: '4K', dur: '10s', fl2v: 'yes', audio: '-', notes: '5 or 10s fixed lengths', strengths: '-', weaknesses: '-' },
  { model: 'Runway Gen 4 Turbo', native: '720p', sweet: '1080p', max: '-', dur: '10s', fl2v: 'yes', audio: '-', notes: 'Faster inference variant', strengths: '-', weaknesses: '-' },
  { model: 'Runway Gen-4 Act Two', native: '-', sweet: '-', max: '-', dur: '-', fl2v: '-', audio: '-', notes: 'Specs unavailable/unreleased', strengths: '-', weaknesses: '-' },
  { model: 'Sora 2 Pro', native: '1080p', sweet: '1080p', max: '1080p', dur: '25s', fl2v: 'yes', audio: 'yes', notes: 'Discontinued by OpenAI', strengths: '-', weaknesses: '-' },
  { model: 'Sora 2 Max', native: '-', sweet: '-', max: '-', dur: '-', fl2v: '-', audio: '-', notes: 'No data found', strengths: '-', weaknesses: '-' },
  { model: 'Hunyuan Video', native: '720p', sweet: '1080p', max: '4K', dur: '5s', fl2v: 'yes', audio: '-', notes: 'Default 121 frames (5s). v2.0 supports 4K', strengths: '-', weaknesses: '-' },
  { model: 'LTX 2.3 Pro', native: '1080p', sweet: '4K', max: '4K', dur: '20s', fl2v: 'yes', audio: 'yes', notes: 'Production-grade, audio sync', strengths: '-', weaknesses: '-' },
  { model: 'LTX 2 Fast', native: '1080p', sweet: '4K', max: '4K', dur: '20s', fl2v: 'yes', audio: 'yes', notes: 'Optimized for speed', strengths: '-', weaknesses: '-' },
  { model: 'PixVerse V6', native: '1080p', sweet: '1080p', max: '1080p', dur: '15s', fl2v: 'yes', audio: '-', notes: 'Relaxed duration limits', strengths: '-', weaknesses: '-' },
  { model: 'PixVerse V5.6', native: '1080p', sweet: '1080p', max: '1080p', dur: '10s', fl2v: 'yes', audio: '-', notes: '-', strengths: '-', weaknesses: '-' },
  { model: 'PixVerse V5', native: '1080p', sweet: '1080p', max: '1080p', dur: '8s', fl2v: 'yes', audio: '-', notes: '-', strengths: '-', weaknesses: '-' },
  { model: 'PixVerse V4.5', native: '1080p', sweet: '1080p', max: '1080p', dur: '8s', fl2v: 'yes', audio: '-', notes: '-', strengths: '-', weaknesses: '-' },
  { model: 'PixVerse V4', native: '1080p', sweet: '1080p', max: '1080p', dur: '8s', fl2v: 'yes', audio: '-', notes: '5s usually locked for 1080p', strengths: '-', weaknesses: '-' },
  { model: 'Mochi 1', native: '480p', sweet: '480p', max: '720p', dur: '5.4s', fl2v: '-', audio: '-', notes: 'Open source (848x480 native)', strengths: '-', weaknesses: '-' },
  { model: 'Pyramid Flow', native: '768p', sweet: '768p', max: '768p', dur: '10s', fl2v: 'yes', audio: '-', notes: 'Pyramidal flow matching', strengths: '-', weaknesses: '-' },
  { model: 'ToonCrafter', native: '512x320', sweet: '512x320', max: '512x512', dur: '2s', fl2v: 'yes', audio: '-', notes: 'Interpolation model (16 frames max)', strengths: '-', weaknesses: '-' },
  { model: 'Play (Open MMLab)', native: '-', sweet: '-', max: '-', dur: '-', fl2v: '-', audio: '-', notes: 'Likely referring to PIA/MMagic toolboxes', strengths: '-', weaknesses: '-' },
];
...
function sortHeaders(cols, sort) {
  return cols.map((c) => `<th data-sort="${c.key}" class="sortable${sort.key === c.key ? ' sorted' : ''}${c.cls ? ' ' + c.cls : ''}">${esc(c.label)}<span class="ref-sort-arrow">${sort.key === c.key ? (sort.dir === 1 ? ' ▲' : ' ▼') : ''}</span></th>`).join('');
}
