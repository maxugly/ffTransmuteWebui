...
const MODELS_ROWS = [
  ...
  { model: 'PixVerse V5', crazy: 'yes', category: 'Stylized', released: '2025-08', native: '1080p', sweet: '1080p @ 8s', max: '1080p', dur: '8s', fl2v: 'yes', audio: 'no', notes: 'Dynamic stylized animation engine', strengths: 'High motion responsiveness, vibrant visual styles', weaknesses: 'No native audio', tips: 'Keep prompts focused on visual style and atmosphere.' },
  { model: 'PixVerse V4.5', crazy: 'yes', category: 'Stylized', released: '2025-04', native: '1080p', sweet: '1080p @ 8s anime', max: '1080p', dur: '8s', fl2v: 'yes', audio: 'no', notes: 'Keyframe transition stability for anime', strengths: 'Fluid motion for 2D/3D illustrative artwork', weaknesses: 'Causes limb clipping in complex multi-subject scenes', tips: 'Keep camera movement prompts gentle.' },
  { model: 'PixVerse V4', crazy: 'yes', category: 'Stylized', released: '2024-12', native: '1080p', sweet: '1080p @ 8s', max: '1080p', dur: '8s', fl2v: 'yes', audio: 'no', notes: '5s usually locked for 1080p', strengths: 'Early motion brush controls, vector graphics rendering', weaknesses: 'Prone to static human facial expressions', tips: 'Restrict prompts to single subjects.' },
  { model: 'Mochi 1', crazy: 'yes', category: 'Open / Self-Host', released: '2024-10', native: '480p (848x480 native)', sweet: '480p @ 30fps (163f)', max: '848x480 (Native)', dur: '5.4s', fl2v: 'no', audio: 'no', notes: 'Genmo open-source Asymmetric Diffusion Transformer (AsymDiT)', strengths: 'Extreme organic motion fluidity, zero visual tearing during fast moves, fluid splash & cloth physics', weaknesses: 'Hard-locked to 848x480 native resolution (do NOT override; upscale externally)', tips: 'Pipe raw 848x480 output into spatial upscalers for 1080p; use hyper-kinetic force prompt terms (swirling vortex, fluid splash).' },
...
function modelsSortValue(r, key) {
  ...
  if (key === 'fl2v' || key === 'audio' || key === 'crazy') return { yes: '0', '?': '1', no: '2' }[r[key]] || '1';
  const v = r[key] || '';
  return v === '—' ? '' : v;
}
